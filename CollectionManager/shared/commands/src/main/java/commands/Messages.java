...
public class Messages {
    ...
    public static class Commands {
        private static final ResourceBundle EXCEPTIONS_BUNDLE =
    ...
    public static class Requirements {
        ...
        public static final String VALIDATION_ERROR =
            EXCEPTIONS_BUNDLE.getString("ValidationError");

        public static final String REQUIREMENT_ASK_ERROR =
            EXCEPTIONS_BUNDLE.getString("RequirementAskError");
